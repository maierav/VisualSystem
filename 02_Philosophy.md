...
In fact, deviations of visual perception from reality occur all the time, including right now as you read this. You cannot see how the image in the eye is constantly shifting and moving as your eyes dart around about three times a second ([1](https://doi.org/10.1037/0033-2909.124.3.372)). In fact, you cannot even see the brief moments of darkness that occur some fifteen to twenty times a minute when you briefly close your eyes to blink ([2](https://doi.org/10.1002/mds.870120629)); the visual system actively suppresses them ([3](https://doi.org/10.1126/science.7355270)). You cannot see a hole in your visual image when you close one eye, despite your blindspot being just that ([4](https://doi.org/10.1038/350699a0)). You cannot see the blood vessels that run in front of your photoreceptors despite them casting shadows. You see colors instead of varying wavelengths of light. Different wavelength combinations of light seem as the same color to you. And one and the same combination of light wavelengths can look like an entirely different color depending on the context of stimulation ([5](https://doi.org/10.1126/science.8266102)). The list goes on and on and on...

## Perception as Inference

Most researchers that have or do study perception thus go far beyond the assumption that naïve realism "works most of the time". Instead, they tend to understand perception as being something rather different from physical reality. 

A common notion is that **perception is an interpretation** of physical reality. 

What this means is that perception seems to reflect the outcome of a process of _inference_. Where "inference" describes that the outcome are _assumptions_ (about objective reality). However, not just any arbitrary assumptions. But assumptions that are grounded in _evidence_ (light projections in the back of your eyes / sensory data / sensation). For example, certain flat (2D) images immediately look 3D, as if "popping out of the screen", because your perception reflects the assumption that what you are looking at is part of a three-dimensional world. This idea goes back to Hermann von Helmholtz in the nineteenth century and has its modern form in the view of perception as Bayesian inference ([6](https://doi.org/10.1146/annurev.psych.55.090902.142005); [7](https://doi.org/10.1016/j.tins.2004.10.007)).
...
Perception on this view is an entirely new, subjective reality that both _adds to_ objective physical reality by _making sense_ of what we see (such as by filling in your blindspot) as well as _subtracts from_ objective reality by leaving invisible what is deemed irrelevant (such as the shadows of your retinal blood vessels).

Some researchers agree on the notion that perception reflects the outcome of an "active" process, but hesitate to identify that process as inference, interpretation, or assumptions about incoming sensory data (such as a new pattern of light on your retina). Instead, they think this process might be more related to incoming sensory data _challenging_ or _conflicting_ with existing assumptions. On this view, it is the interplay between what is **predicted by internal assumptions** and **deviating evidence** that proves these predictions (and hence the underlying assumptions) wrong that marks perception ([8](https://doi.org/10.1038/4580); [9](https://doi.org/10.1017/S0140525X12000477)).
...
A camera, even after a lot of processing, shows light patterns "as they are", such as three black pac men on a white background. But our eyes lead to a different outcome. We see a triangle on top of solid black disks instead ([10](https://doi.org/10.1038/scientificamerican0476-48)).

We move our eyes (several times a second), and yet perceive a stable visual image ([11](https://doi.org/10.1016/j.visres.2008.03.021)). (Video) cameras are held still or reduced to slow and minimal motion to avoid "jumpy" images.

Our eyes are round. The images (the light patterns) on the "back of our eyes" really land inside a hollow sphere and hence are _curved_ (radially distorted). The images on the back of cameras are flat. Our perception is also uneven - we see great detail and sharpness at the center of our view and an almost blurry image at the edges of our visual field. This is not because of the curvature, but because the light-sensitive cells are packed far more densely at the center of the retina than anywhere else ([12](https://doi.org/10.1002/cne.902920402)). Cameras can deliver sharp images throughout.
