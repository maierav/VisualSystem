...
At the same time, we refer to camera-based robotic devices, such as self-driving cars or autonomous vacuum cleaners as using "vision". We might even say something like: "The robo car did not see the obstructed traffic light" in order to clarify that its sensors could not make out whether a traffic light was red or green. Yet, most of us intuit that robotic vacuum cleaners have little to no conscious experience. What they do instead is to **sense** and process their environment using light.

So, vision describes at least two separate phenomena: 

(1) Unconscious sensing using light as a signal.

(2) A specific type of conscious experience.

and we can add at least one third phenomenon to that list:
...
So, how do we avoid such confusion?
